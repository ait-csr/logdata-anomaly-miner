...
def get_model():
    ...
    user_info = SequenceModelElement(
        "user_info",
        [
            FixedDataModelElement("user_str", b"user=<"),
            OptionalMatchModelElement("user", DelimitedDataModelElement("user", b">")),
                ...
                [
                    ...
                    SequenceModelElement(
                        ...
                        [  # This only occurs in auth.log
                            ...
                            DelimitedDataModelElement("name", b")"),
                            FixedDataModelElement(
                                "session_str", b"): authentication failure; logname="
                            ),
                            OptionalMatchModelElement(
                    ...
                    SequenceModelElement(
                        ...
                        [
                            FixedDataModelElement(
                                "liblogging_str", b" liblogging-stdlog: "
                            ),
                            ...
                            FirstMatchModelElement(
                                ...
                                [
                                    SequenceModelElement(
                                        ...
                                        [
                                            FixedDataModelElement(
                                                "dhcprequest_str", b"DHCPREQUEST of "
                                            ),
                                    ...
                                    SequenceModelElement(
                                        ...
                                        [
                                            FixedDataModelElement(
                                                "bound_str", b"bound to "
                                            ),
                                            IpAddressDataModelElement("ip"),
                                            FixedDataModelElement(
                                                "renewal_str", b" -- renewal in "
                                            ),
                                            DecimalIntegerValueModelElement("seconds"),
                                            FixedDataModelElement(
                                                "seconds_str", b" seconds."
                                            ),
                                        ],
                                    ),
                                ],
