...
def get_model(user_name_model=None):
    ...
    type_children = [
        ...
        SequenceModelElement(
            ...
            [
                FixedDataModelElement(
                    "s0", b"Excess permission or bad ownership on file /var/log/btmp"
                )
            ],
        ),
        SequenceModelElement(
        ...
        SequenceModelElement(
            ...
            [
                FixedDataModelElement(
                    "s0", b"error: channel_setup_fwd_listener: cannot listen to port: "
                ),
                DecimalIntegerValueModelElement("port"),
            ],
        ),
                ...
                FirstMatchModelElement(
                    ...
                    [
                        ...
                        SequenceModelElement(
                            ...
                            [
                                FixedDataModelElement(
                                    "s0", b"forced-command (key-option) '"
                                ),
