...
def get_model():
    ...
    type_branches = {
        ...
        "BPRM_FCAPS": SequenceModelElement(
            "bprmfcaps",
            [
        ...
        "CONFIG_CHANGE": SequenceModelElement(
            "conf-change",
            [
        ...
        "CRED_REFR": SequenceModelElement(
            "creddisp",
            [
                FixedDataModelElement("s0", pid),
                DecimalIntegerValueModelElement("pid"),
    ...
    exec_arg_model = SequenceModelElement(
        "execarg",
        [
    ...
    type_branches["EXECVE"] = SequenceModelElement(
        "execve",
        [
    ...
    type_branches["FD_PAIR"] = SequenceModelElement(
        "fdpair",
        [
    ...
    type_branches["LOGIN"] = SequenceModelElement(
        "login",
        [
            FixedDataModelElement("s0", pid),
            DecimalIntegerValueModelElement("pid"),
    ...
    type_branches["OBJ_PID"] = SequenceModelElement(
        "objpid",
        [
    ...
    type_branches["PATH"] = SequenceModelElement(
        "path",
        [
    ...
    type_branches["PROCTITLE"] = SequenceModelElement(
        "proctitle",
        [
    ...
    type_branches["SOCKADDR"] = SequenceModelElement(
        "sockaddr",
        [
    ...
    type_branches["SYSCALL"] = SequenceModelElement(
        "syscall",
        [
    ...
    type_branches["USER_ACCT"] = SequenceModelElement(
        "useracct",
        [
            FixedDataModelElement("s0", pid),
            DecimalIntegerValueModelElement("pid"),
    ...
    type_branches["USER_AUTH"] = SequenceModelElement(
        "userauth",
        [
            FixedDataModelElement("s0", pid),
            DecimalIntegerValueModelElement("pid"),
    ...
    type_branches["USER_START"] = SequenceModelElement(
        "userstart",
        [
            FixedDataModelElement("s0", pid),
            DecimalIntegerValueModelElement("pid"),
    ...
    type_branches["USER_END"] = SequenceModelElement(
        "userend",
        [
            FixedDataModelElement("s0", pid),
            DecimalIntegerValueModelElement("pid"),
    ...
    type_branches["USER_ERR"] = SequenceModelElement(
        "usererr",
        [
            FixedDataModelElement("s0", pid),
            DecimalIntegerValueModelElement("pid"),
    ...
    type_branches["USER_LOGIN"] = SequenceModelElement(
        "userlogin",
        [
            FixedDataModelElement("s0", pid),
            DecimalIntegerValueModelElement("pid"),
        ...
        [
            ...
            FirstMatchModelElement(
                ...
                [
                    ...
                    FixedDataModelElement(
                        "queue-full", b"queue is full - dropping event"
                    ),
                ],
            ),
        ],
